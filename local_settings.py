...
MY_CONSUMER_KEY = 'Introduce consumer key'   #Your Twitter API Consumer Key set in Heroku config
MY_CONSUMER_SECRET = 'Introduce consumer secret key' #Your Consumer Secret Key set in Heroku config
MY_ACCESS_TOKEN_KEY = 'Introduce API access token key'   #Your Twitter API Access Token Key set in Heroku config
MY_ACCESS_TOKEN_SECRET = 'Introduce API access token secret key'   #Your Access Token Secret set in Heroku config
